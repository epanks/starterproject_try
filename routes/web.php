...
Route::get('/balai/{id}', 'BalaiController@balai');
Route::get('/balai/{id}/kdoutput', 'BalaiController@kdoutput')->name('balaicontroller.kdoutput');
Route::get('/balai/{id}/showoutput', 'BalaiController@showoutput')->name('balai.showoutput');
